                                ...
                                <table id="posDatatable" class="table table-striped table-bordered table-condensed table-hovered" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 110px; text-align: right;"><?= 'Q' . number_format($v['total'], 2, '.', ',') ?></td>
                                            ...
                                            <td class="no-print" style="text-align: center; width: 180px;">
                                                <?php
												$imagen = $this->model->get_all_imagenes($v['id']);
												?>
												<a href="<?= base_url('reportes/showimagen/' . $v['id']) ?>" target="_blank" class="btn btn-info btn-sm">VER PEDIDO ELIMINADO</a>
                                            </td>
                                        </tr>
                                        <?php
                                            }
