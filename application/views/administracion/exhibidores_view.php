            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0"><?= $title . ' / Exhibidores' ?></h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                    ...
                    <div class="card card-h-100">
                        <div class="card-body">
                            ...
                            <div class="alert alert-danger" role="alert">
                                Exihibidor ya existe en la base de datos
                            </div>
                            <?php
                            }
                            ?>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-condensed table-hovered" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                        <tr <?= ($e['status'] == 0)?'style="color: #b8b8b8;"':'' ?>>
                                            <td><?= $e['descripcion'] ?></td>
                                            <?php
                                            if($e['status'] == 0){
                                            ?>
                                            <td class="no-print" style="text-align: center; width: 50px;">
                                                <a href="<?= base_url('administracion/exhibidores/reactivar_exhibidor/' . $e['id']) ?>" class="btn btn-sm btn-default"><i class="fa fa-refresh"></i></a>
                                            </td>
                                            <?php
                                            }else{
                                            ?>
                                            <td class="no-print" style="text-align: center; width: 40px;">
                                                <a href="<?= base_url('administracion/exhibidores/eliminar_exhibidor/' . $e['id']) ?>" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>
                                            </td>
                                            <?php
                                            }
                                            ?>
